...
export class FioEngine extends CurrencyEngine {
  ...
  constructor(
    ...
    super(currencyPlugin, walletInfo, opts);FioEngine.prototype.__init.call(this);FioEngine.prototype.__init2.call(this);
    ...
    */
    const stakedAmountIndex =
      this.otherData.stakingStatus.stakedAmounts.findIndex(stakedAmount => {
        // $FlowFixMe
        return _optionalChain([stakedAmount, 'access', _ => _.unlockDate, 'optionalAccess', _2 => _2.getTime, 'call', _3 => _3()]) === unlockDate.getTime()
      })
    ...
    */
    if (stakedAmountIndex < 0) {
      ...
      const needleIndex = this.otherData.stakingStatus.stakedAmounts.findIndex(
        (stakedAmount, index) =>
          // $FlowFixMe
          unlockDate.getTime() >= (_nullishCoalesce(_optionalChain([stakedAmount, 'access', _4 => _4.unlockDate, 'optionalAccess', _5 => _5.getTime, 'call', _6 => _6()]), () => ( 0)))
      )
...
,
    ...
    try {
      ...
      if (e.errorCode && fioApiErrorCodes.indexOf(e.errorCode) > -1) {
        ...
        res = {
          ...
          data: {
            code: e.errorCode,
            message: _nullishCoalesce(e.message, () => ( safeErrorMessage(e))),
            json: e.json,
            list: e.list
          }
        }
  ...
  async executePreparedTrx(
    ...
    this.setFioSdkBaseUrl(apiUrl)
    let res
    this.warn(`SecuX executePreparedTrx\n`)
    this.warn(
 ...
 = {}
  ...
  __init2() {this.removeFioRequest = (fioRequestId, type) => {
  ...
  async makeSpend(edgeSpendInfoIn) {
    ...
    const { name, params } = otherParams.action
